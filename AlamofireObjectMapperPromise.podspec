...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AlamofireObjectMapperPromise.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ZhihuaZhang/AlamofireObjectMapperPromise'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ZhihuaZhang' => 'shika.cho@kapps.co.jp' }
  s.source           = { :git => 'https://github.com/ZhihuaZhang/AlamofireObjectMapperPromise.git', :tag => s.version.to_s }
